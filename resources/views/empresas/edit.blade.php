...
@section('content')
    <h2 class="text-center mb-5">Actualizar empresa: {{$empresa->name}}</h2>


    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
        <a href="{{ route('index') }}" class="btn btn-success mb-5">volver al index</a>
            <form method="POST" action="{{ route('update', ['id' => $empresa->id]) }}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
